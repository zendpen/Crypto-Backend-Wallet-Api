...
* @returns {any}
*/
export function createMultisigWithFee(sender_address, addresses, value, required, nonce, duration, gas_limit, gas_fee_cap, gas_premium) {
...
* @returns {any}
*/
export function createMultisig(sender_address, addresses, value, required, nonce, duration) {
    var ptr0 = passStringToWasm0(sender_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passArrayJsValueToWasm0(addresses, wasm.__wbindgen_malloc);
    var len1 = WASM_VECTOR_LEN;
...
* @returns {string}
*/
export function getCid(signed_message) {
    try {
        const retptr = wasm.__wbindgen_export_4.value - 16;
        wasm.__wbindgen_export_4.value = retptr;
