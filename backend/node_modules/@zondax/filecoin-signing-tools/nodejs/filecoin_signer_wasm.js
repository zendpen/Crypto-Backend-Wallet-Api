...
function __wbg_adapter_28(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6d29d1473c85ef91(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {ExtendedKey}
*/
module.exports.keyDerive = function(mnemonic, path, password) {
...
* @returns {any}
*/
module.exports.createMultisigWithFee = function(sender_address, addresses, value, required, nonce, duration, gas_limit, gas_fee_cap, gas_premium) {
    ...
    var len2 = WASM_VECTOR_LEN;
    int64CvtShim[0] = duration;
    const low3 = u32CvtShim[0];
    const high3 = u32CvtShim[1];
    int64CvtShim[0] = gas_limit;
    ...
    var ret = wasm.createMultisigWithFee(ptr0, len0, ptr1, len1, ptr2, len2, required, nonce, low3, high3, low4, high4, ptr5, len5, ptr6, len6);
    return takeObject(ret);
};
...
* @returns {any}
*/
module.exports.createMultisig = function(sender_address, addresses, value, required, nonce, duration) {
    var ptr0 = passStringToWasm0(sender_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passArrayJsValueToWasm0(addresses, wasm.__wbindgen_malloc);
    var len1 = WASM_VECTOR_LEN;
    ...
    const low3 = u32CvtShim[0];
    const high3 = u32CvtShim[1];
    var ret = wasm.createMultisig(ptr0, len0, ptr1, len1, ptr2, len2, required, nonce, low3, high3);
    return takeObject(ret);
};
...
module.exports.proposeMultisigWithFee = function(multisig_address, to_address, from_address, amount, nonce, gas_limit, gas_fee_cap, gas_premium) {
    ...
    var ptr6 = passStringToWasm0(gas_premium, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len6 = WASM_VECTOR_LEN;
    var ret = wasm.proposeMultisigWithFee(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, nonce, low4, high4, ptr5, len5, ptr6, len6);
    return takeObject(ret);
};
...
module.exports.approveMultisigWithFee = function(multisig_address, message_id, proposer_address, to_address, amount, from_address, nonce, gas_limit, gas_fee_cap, gas_premium) {
    ...
    var ret = wasm.approveMultisigWithFee(ptr0, len0, message_id, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, nonce, low5, high5, ptr6, len6, ptr7, len7);
    return takeObject(ret);
};
...
module.exports.cancelMultisigWithFee = function(multisig_address, message_id, proposer_address, to_address, amount, from_address, nonce, gas_limit, gas_fee_cap, gas_premium) {
    ...
    var ptr7 = passStringToWasm0(gas_premium, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len7 = WASM_VECTOR_LEN;
    var ret = wasm.cancelMultisigWithFee(ptr0, len0, message_id, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, nonce, low5, high5, ptr6, len6, ptr7, len7);
    return takeObject(ret);
};
...
module.exports.createPymtChanWithFee = function(from_address, to_address, amount, nonce, gas_limit, gas_fee_cap, gas_premium) {
    ...
    var len5 = WASM_VECTOR_LEN;
    var ret = wasm.createPymtChanWithFee(ptr0, len0, ptr1, len1, ptr2, len2, nonce, low3, high3, ptr4, len4, ptr5, len5);
    return takeObject(ret);
};
...
module.exports.settlePymtChanWithFee = function(pch_address, from_address, nonce, gas_limit, gas_fee_cap, gas_premium) {
    ...
    var len4 = WASM_VECTOR_LEN;
    var ret = wasm.settlePymtChanWithFee(ptr0, len0, ptr1, len1, nonce, low2, high2, ptr3, len3, ptr4, len4);
    return takeObject(ret);
};
...
module.exports.collectPymtChanWithFee = function(pch_address, from_address, nonce, gas_limit, gas_fee_cap, gas_premium) {
    ...
    var ptr4 = passStringToWasm0(gas_premium, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len4 = WASM_VECTOR_LEN;
    var ret = wasm.collectPymtChanWithFee(ptr0, len0, ptr1, len1, nonce, low2, high2, ptr3, len3, ptr4, len4);
    return takeObject(ret);
};
...
module.exports.updatePymtChanWithFee = function(pch_address, from_address, signed_voucher, nonce, gas_limit, gas_fee_cap, gas_premium) {
    ...
    var ptr5 = passStringToWasm0(gas_premium, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len5 = WASM_VECTOR_LEN;
    var ret = wasm.updatePymtChanWithFee(ptr0, len0, ptr1, len1, ptr2, len2, nonce, low3, high3, ptr4, len4, ptr5, len5);
    return takeObject(ret);
};
...
* @param {BigInt} time_lock_min
* @param {BigInt} time_lock_max
* @param {string} amount
* @param {BigInt} lane
* @param {BigInt} nonce
* @param {BigInt} min_settle_height
* @returns {any}
*/
module.exports.createVoucher = function(payment_channel_address, time_lock_min, time_lock_max, amount, lane, nonce, min_settle_height) {
    ...
    var len0 = WASM_VECTOR_LEN;
    int64CvtShim[0] = time_lock_min;
    const low1 = u32CvtShim[0];
    const high1 = u32CvtShim[1];
    int64CvtShim[0] = time_lock_max;
    const low2 = u32CvtShim[0];
    const high2 = u32CvtShim[1];
    var ptr3 = passStringToWasm0(amount, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len3 = WASM_VECTOR_LEN;
    uint64CvtShim[0] = lane;
    const low4 = u32CvtShim[0];
    const high4 = u32CvtShim[1];
    uint64CvtShim[0] = nonce;
    const low5 = u32CvtShim[0];
    const high5 = u32CvtShim[1];
    int64CvtShim[0] = min_settle_height;
    const low6 = u32CvtShim[0];
    const high6 = u32CvtShim[1];
    var ret = wasm.createVoucher(ptr0, len0, low1, high1, low2, high2, ptr3, len3, low4, high4, low5, high5, low6, high6);
    return takeObject(ret);
};
...
/**
* @param {any} signed_message
* @returns {string}
*/
module.exports.getCid = function(signed_message) {
    try {
        const retptr = wasm.__wbindgen_export_4.value - 16;
        wasm.__wbindgen_export_4.value = retptr;
        wasm.getCid(retptr, addHeapObject(signed_message));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        return getStringFromWasm0(r0, r1);
    } finally {
...
* @returns {any}
*/
module.exports.getVersion = function(transport_wrapper) {
...
* @returns {any}
*/
module.exports.keyRetrieveFromDevice = function(path, transport_wrapper) {
    var ptr0 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.showKeyOnDevice = function(path, transport_wrapper) {
    var ptr0 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.transactionSignRawWithDevice = function(message, path, transport_wrapper) {
...
* @returns {any}
*/
module.exports.transactionSignWithDevice = function(unsigned_tx_js, path, transport_wrapper) {
    var ptr0 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.appInfo = function(transport_wrapper) {
...
* @returns {any}
*/
module.exports.deviceInfo = function(transport_wrapper) {
...
function __wbg_adapter_94(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h0b69795033e72fe1(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
module.exports.__wbg_from_97df795a364445c8 = function(arg0, arg1) {
    var ret = new Buffer(getArrayU8FromWasm0(arg0, arg1));
    return addHeapObject(ret);
};

module.exports.__wbg_exchange_6c195caeaf4d0a08 = function(arg0, arg1) {
...
module.exports.__wbg_reject_5d8c18a490c1b8b2 = function(arg0) {
...
module.exports.__wbg_has_c10fc8c7bef9b293 = handleError(function(arg0, arg1) {
...
module.exports.__wbindgen_closure_wrapper718 = function(arg0, arg1, arg2) {
    var ret = makeMutClosure(arg0, arg1, 184, __wbg_adapter_28);
    return addHeapObject(ret);
};
