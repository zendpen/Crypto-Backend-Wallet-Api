...
export declare const _apiFallbacks: {
    fetchUTXO: (testnet: boolean, txHash: string, vOut: number) => ((() => Promise<UTXO>) | (() => Promise<UTXO>))[];
    fetchUTXOs: (testnet: boolean, address: string, confirmations: number) => (() => Promise<readonly UTXO[]>)[];
    fetchTXs: (testnet: boolean, address: string, confirmations?: number) => ((() => Promise<readonly UTXO[]>) | (() => Promise<readonly UTXO[]>) | (() => Promise<UTXO[]>))[];
    broadcastTransaction: (testnet: boolean, hex: string) => (() => Promise<string>)[];
};
export declare class BTCHandler implements Handler {
